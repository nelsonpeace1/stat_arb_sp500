...
class BackTest: 
    ...
    def __init__(
        ...
        self.trade_history_frame = pd.DataFrame(columns=self.TRADE_DF_RECORD_COLUMNS_LIST)
    ...
    def trade(
        ...
        if (self.standardised_spread.iloc[0] > self.spread_to_abandon_trade) or (
            ...
            self.trade_history_frame.loc[self.FIRST_INDEX_TRADE_DF, "trade_abandoned"] = True
            self.trade_history_frame.loc[
